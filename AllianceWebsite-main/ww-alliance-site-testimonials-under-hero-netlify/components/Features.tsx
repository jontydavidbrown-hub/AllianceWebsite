...
const items = [
  ...
  },
  {
    ...
    desc:
      "100% guaranteed wins. Our arbitrage software detects bets with a 100% win rate and delivers them up to 500+ times per day.",
    ...
    <section id="features" className="py-16 lg:py-24 border-t border-[var(--border)]">
      <div className="container-safe">
        ...
        <motion.p
          ...
          viewport={{ once: true, amount: 0.4 }}
          variants={fadeUp}
          className="mt-2 text-[color:var(--muted)]"
        >
        ...
        >
          {items.map((it) => (
            <motion.div
              key={it.title}
              variants={fadeUp}
              className="rounded-2xl ring-1 ring-[var(--border)] overflow-hidden bg-[color:var(--surface)] hover-card"
            >
